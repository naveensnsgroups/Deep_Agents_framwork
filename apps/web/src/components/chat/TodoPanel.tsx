...
const STATUS_ICON_CLASS: Record<string, string> = {
  ...
  in_progress: "text-blue-300 light:text-blue-800 animate-spin",
  pending: "text-neutral-500",
};

const STATUS_TEXT_CLASS: Record<string, string> = {
  completed: "text-neutral-500 line-through",
  in_progress: "text-blue-200 light:text-blue-800",
  pending: "text-neutral-300 light:text-neutral-700",
};
  ...
  return (
    <div className="flex-none border-b border-neutral-800 light:border-neutral-200 px-3 py-2.5">
      ...
      {todos.map((todo, i) => {
        ...
        return (
          <div key={i} className={`flex items-start gap-1.5 py-0.5 text-xs ${STATUS_TEXT_CLASS[todo.status] ?? "text-neutral-300 light:text-neutral-700"}`}>
